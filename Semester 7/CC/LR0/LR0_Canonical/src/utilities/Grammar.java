...
public class Grammar {
    ...
    public HashSet<Rule> getRuledByLeftVariable(String variable) {
        ...
        */
        for (Rule rule : rules) {
            System.out.println("getRuledByLeftVariable : "+rule);
            /*1st iteration contain getRuledByLeftVariable : S' -> E condition is false
            2nd iteration contain getRuledByLeftVariable : E -> E + ( E ) condition is true
            3rd iteration contain getRuledByLeftVariable : E -> a  condition is true
            */
            if (rule.getLeftSide().equals(variable)) {
